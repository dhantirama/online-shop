...
<table class="table table-bordered">
		<th style=" background: #E6E6FA; "><center>Judul Film</center></th>
	...
	<tr>
		<td><center><?php $data=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from film where id_film='$c[id_film]'"));$nama=$data['judul']; echo $nama; ?></center></td>
