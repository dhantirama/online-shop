...
<div class="vid-container">
  ...
  <div class="inner-container">
    ...
    <div class="box">
      ...
      <form action="ceklogin_dhanti.php" method="post">
      <input type="text" placeholder="Username" name="username"/>
      <input type="password" placeholder="Password" name="password" />
      <button type="submit">Login</button>
      </form>
      <p>Belum punya akun?
       <span><a href="daftar_dhanti.php?" style="color: #D4E7C5;">Daftar</a></span></p>
       <p>Kembali Ke <span><a href="index.php" style="color: #D4E7C5;">Halaman Utama</a></span></p>
    </div>
  </div>
</div>
</body>
